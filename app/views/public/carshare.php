                ...
                <div class="item">
                    ...
                    <div class="item-footer">
                        ...
                        <?php elseif ($offer['available_spaces'] > 0): ?>
                            <button class="btn btn-primary" onclick="openRequestModal(<?php echo (int)$offer['id']; ?>, <?php echo json_encode(displayName($offer['discord_name'])); ?>)">Request to Join</button>
                        <?php else: ?>
