...
class Activity {
    ...
    public function create($data) {
        $sql = "INSERT INTO activities (event_id, title, description, day, start_time, end_time, max_capacity, requires_prepayment, price, total_price, deposit_amount, prepayment_required, pay_on_arrival)
