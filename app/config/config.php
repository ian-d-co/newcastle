 ...
 * Core configuration is now handled by app/bootstrap.php
 * 
 * Note: This file is loaded by bootstrap.php after all constants are defined.
 */

// Ensure bootstrap has been loaded first
if (!defined('BASE_PATH')) {
    die('Configuration Error: Bootstrap must be loaded before config.php');
}
