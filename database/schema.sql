...
-- Carshare requests table (request/accept workflow)
...
-- Hosting requests table (request/accept workflow)
...
CREATE TABLE IF NOT EXISTS activities (
    ...
    pay_on_arrival BOOLEAN DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS hotel_rooms (
    ...
    single_price_friday DECIMAL(10,2) DEFAULT 0.00,
    single_price_saturday DECIMAL(10,2) DEFAULT 0.00,
    double_price_friday DECIMAL(10,2) DEFAULT 0.00,
    double_price_saturday DECIMAL(10,2) DEFAULT 0.00,
    triple_price_friday DECIMAL(10,2) DEFAULT 0.00,
    triple_price_saturday DECIMAL(10,2) DEFAULT 0.00,
    breakfast_included BOOLEAN DEFAULT FALSE,
    book_direct_with_hotel BOOLEAN DEFAULT FALSE,
    book_with_group BOOLEAN DEFAULT FALSE,
    group_payment_due DATE NULL,
    confirmation_deadline DATETIME NULL,
    payment_deadline DATETIME NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
